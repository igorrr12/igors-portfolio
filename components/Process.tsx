...
/** Numbered catalogue entries. The animated rule lives in WallLabel; step
 *  rows settle in a scrubbed stagger; separators stay static. */
export function Process() {
  return (
    ...
    >
      ...
      <Reveal selector="li" className="mt-10">
        <ol>
